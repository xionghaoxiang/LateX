...
$\boldsymbol{v_{FY_i}}$ & 无人机速度向量 & m/s \\
$\boldsymbol{n_{M_j}}$ & 导弹飞行方向单位向量 & - \\
$\alpha$ & 无人机飞行航向角 & rad \\
$g$ & 重力加速度 & m/s$^2$ \\
$t_{drop}$ & 烟幕弹投放时刻 & s \\
$t_{burst}$ & 烟幕弹起爆时刻 & s \\
...
& \mathbf{P}_{FY_1}\left( t \right) =\mathbf{P}_{FY_1}\left( 0 \right) +\mathbf{v}_{FY_1}t \\
& \mathbf{P}_{B}=\mathbf{P}_{FY_1}(t_{drop})+\mathbf{v}_{FY_1}t_{delay}-\left( 0,0,\frac{1}{2}gt_{delay}^2 \right) \\
...
无人机FY1航向方向角为180.67°,速度大小为95m/s时对应的最大有效遮挡时间是12.54241s
