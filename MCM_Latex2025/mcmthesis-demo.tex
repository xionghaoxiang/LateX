...
\begin{table}[ht]
  ...
  \begin{tabular}{@{}clcccc@{}}
    ...
    \midrule
    $P_{\text{out}}$\quad\hltext{($w$)} & 2.94 & 7.27 & 4.94 & 3.23 & 12.13 \\
...
With the help of \textit{Mathematica}, we obtain the curve of $P_{\text{out}}(x)$, and the result is shown in fig.\ref{fig:image15}. Compared with 2021 UCI, the Tokyo circuit is more complicated; the difficulty of the riders' power-distribution strategy has also increased significantly.
\vspace{-0.5cm}
\begin{figure}[H]
  \centering
